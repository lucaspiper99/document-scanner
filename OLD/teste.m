...
%function pivproject2021(task,  reference_path ,path_to_output_folder , path_to_input_folder, arg2)
        ...
        reference(1:a,a+1:size(reference,2)-a,1) = repelem( [0:(255/a):(255-255/a)]' ,1, size(reference,2)-2*a);
        reference(1:a,a+1:size(reference,2)-a,2) = repelem( [0:(255/a):(255-255/a)]' ,1, size(reference,2)-2*a);
        reference(1:a,a+1:size(reference,2)-a,3) = repelem( [0:(255/a):(255-255/a)]' ,1, size(reference,2)-2*a);
        reference((size(reference,1)-a+1):size(reference,1),a+1:size(reference,2)-a,1) = repelem( [flip(0:(255/a):(255-255/a))]' ,1, size(reference,2)-2*a);
        reference((size(reference,1)-a+1):size(reference,1),a+1:size(reference,2)-a,2) = repelem( [flip(0:(255/a):(255-255/a))]' ,1, size(reference,2)-2*a);
        reference((size(reference,1)-a+1):size(reference,1),a+1:size(reference,2)-a,3) = repelem( [flip(0:(255/a):(255-255/a))]' ,1, size(reference,2)-2*a);
        reference(a+1:size(reference,1)-a,1:a,1) = repelem( [0:(255/a):(255-255/a)]' ,1, size(reference,1)-2*a)';
        reference(a+1:size(reference,1)-a,1:a,2) = repelem( [0:(255/a):(255-255/a)]' ,1, size(reference,1)-2*a)';
        reference(a+1:size(reference,1)-a,1:a,3) = repelem( [0:(255/a):(255-255/a)]' ,1, size(reference,1)-2*a)';
        reference(a+1:size(reference,1)-a,(size(reference,2)-a+1):size(reference,2),1) = repelem( [flip(0:(255/a):(255-255/a))]' ,1, size(reference,1)-2*a)';
        reference(a+1:size(reference,1)-a,(size(reference,2)-a+1):size(reference,2),2) = repelem( [flip(0:(255/a):(255-255/a))]' ,1, size(reference,1)-2*a)';
        reference(a+1:size(reference,1)-a,(size(reference,2)-a+1):size(reference,2),3) = repelem( [flip(0:(255/a):(255-255/a))]' ,1, size(reference,1)-2*a)';
        imshow(reference);
